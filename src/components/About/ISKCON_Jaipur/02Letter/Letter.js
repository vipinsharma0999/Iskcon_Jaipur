  ...
  return (
    <div className="py-14 p-4 sm:px-10 bg-[#d17a2920] flex justify-center">
      ...
      <div className="relative w-full flex flex-col justify-center items-center">
        <h1 className={`${play.className} pb-6 px-4 text-center text-4xl xl:text-5xl text-bold`}>
        ...
        <div className="md:w-4/5 p-2 md:p-0 w-full text-justify text-sm sm:text-md xl:text-lg 2xl:text-xl">
          ...
          <p>
            ...
            beautiful Krishna Balarama Temple in Jaipur. In a letter, he wrote,{" "}
            <b className="text-[#d17a29] block pt-1">
              "So I want to open a duplicate Krishna Balarama temple in Jaipur.
              I am sending separately copies of pictures of our Krishna Balarama
              Temple in Vrindaban. Of course there is also Radha Krishna and
              Gaura Nitai. I wish that you have some land in Jaipur and help us
              in constructing a temple like in Vrindaban."
            </b>{" "}
            <b className="text-gray-700 inline-block">(13, July 1975)</b>
          </p>
          <p>
            In 1991, ISKCON Jaipur began its journey, inspired by Srila
            Prabhupada&apos;s vision. Then, in 2019, the grand opening of the temple
            was held, <b>fulfilling Srila Prabhupada&apos;s desire</b> for a Krishna
            Balarama Mandir in Jaipur. Today, ISKCON Jaipur stands as a
            testament to his devotion and serves as a beacon of spiritual
