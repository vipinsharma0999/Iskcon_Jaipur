...
const HomeData = () => {
  ...
  return (
    <div className="bg-opacity-0 flex justify-center bg-white" ref={ref}>
      <motion.div
        className="z-[10] flex 2xl:justify-evenly flex-col lg:flex-row justify-between items-center p-4 border-4 border-[#e5b776] m-[-25px] bg-white xl:w-9/12 w-11/12 lg:h-[100px] sm:h-[300px] h-[360px] mb-10"
