...
export default function SadhuPaymentSection() {
  return (
    <>
         ...
         <div class=" md:mx-16 sm:mx-9 mx-[10px] flex flex-col lg:flex-row py-[20px] bg-[#400669] rounded-lg">
            <div class=" flex flex-col items-center justify-center w-full  lg:w-1/2 pb-[20px]">
              <div className="flex">
                <p
