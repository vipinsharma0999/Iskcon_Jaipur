...
const ExploreMorePaymentSection = () => {
  return (
    <div
      id="paymentSection"
      className="relative md:mx-16 sm:mx-9 mx-[10px] flex flex-col lg:flex-row py-[20px] bg-[#400669] rounded-lg pt-10"
    >
...
export default ExploreMorePaymentSection